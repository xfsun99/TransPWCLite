...
from datasets.flow_datasets import SintelRaw, Ultra
...
def get_dataset(all_cfg):
    ...
    if cfg.type == 'Ultrasound':
        ap_transform = get_ap_transforms(cfg.at_cfg) if cfg.run_at else None

        train_set_1 = Ultra(cfg.root_sintel, n_frames=cfg.train_n_frames, type='us1',
        ...
        train_set_2 = Ultra(cfg.root_sintel, n_frames=cfg.train_n_frames, type='us2',
                             split='training', subsplit=cfg.train_subsplit,
                             with_flow=False,
                             ap_transform=ap_transform,
                             transform=input_transform,
        ...
        valid_set_1 = Ultra(cfg.root_sintel, n_frames=cfg.val_n_frames, type='us1',
        ...
        valid_set_2 = Ultra(cfg.root_sintel, n_frames=cfg.val_n_frames, type='us2',
                             split='training', subsplit=cfg.val_subsplit,
                             transform=valid_input_transform,
                             target_transform={'flow': sep_transforms.ArrayToTensor()}
                             )
